...
## Overview
"Payments and Budget System" is a web application with educational and demonstrative purposes. It mimics (in a much smaller scale) systems used by the institutions in the government sector to make payments and manage their annual budget. You can make different bank payments, cash payments, manage beneficiaries, hire and lay off employees, pay salaries with social security and tax deductions, aquire and manage assets, create and save financial reports and redistribute budget funds between institutions.
...
<ul>
  <li>
    <b>Guest</b> - unregistered user. Guests can only view reports, which are made public by the Primary and Secondary users.
  </li>
  <li>
...
<ul>
  ...
  <li>
    ...
    <li>
    <a href="#bank-payment---aquiring-assets">Bank payment - Aquiring assets</a>
  </li>
    <li>
  ...
  <li>
    <a href="#adminitration-pages">Administration pages</a>
  </li>
  <li>
...
## User registration
On the registration page, you can create a new user profile as either Primary or Secondary user. If you want to create a Secondary user profile, you must select the Primary user you want to be attached to.
...
## Home page
On the home page, Guests can view the reports of a selected institution, which are saved beforehand by the Primary and Secondary users.
...
Upon login, Primary and Secondary users' home page displays short information about the user's access level and unlocks the left nagivation menu for the core functionality of the application.
</br>
</br>
...
<a href="#table-of-contents">Back to index table</a>
## Beneficiaries
Beneficiaries ("Контрагенти") are various business entities, which the institution can make bank payments to.
...
The information page displays a list of all aquired assets and their status (their amortization, balance value etc.) for the selected year and month. You can choose another year and/or month to see the projected future or past status or your assets. You can filter and order the assets in ascending or descending order. Pagination is implemented. From this page, you can nagivate to the information page of the payment made for aquiring the asset, or to Asset details page.
...
On the information page, you can view all your employees with their name, personal identification number, gross salary, dates of hire and layoff and the sum of all payments which they have received. You can search an employee by their name and identifier. You can sort the results by ascending or descending order. Pagination is implemented. 
...
You can hire a new employee by entering their data and the type of their contract. The contract type determines and social security deductions from their monthly salary. The employee's salary cannot be below the minimum wage (the minimum wage can be changed by the Administrator)
...
You can choose between three different types of bank payment. Support payments and Asset payments are made in favour of a beneficiary. Salaries are payments towards all active employees for a chosen month and year. For Asset payment, chooing the type of the expense will affect the type of the purchased assets and their future amortization values.
...
You can initiate support payment by entering all required fields. The date of the invoice cannot be in the future.
...
<a href="#table-of-contents">Back to index table</a>
## Bank payment - Aquiring assets
### Initiating the payment for asset aquisition
...
After choosing year and month for the salaries, the application will accrue all social security, tax deductions and net salaries for all personnel employed by the institution, who have at least one working day during the target month. Each employee will receive salary according to the days of the month they have been employed. All state employees' social security expenses are paid by the employer, while employees on job contracts divide those expenses between the employee and the employer (all deduction percentages and the tax rate can be changed by Administrator).
...
The Budget defines the maximum allowed annual expenses for each institution regarding each payment group seperatly - support, assets and salaries. Users can't make payments that will exceed the budget limit for the respective payment group. </br>
Secondary users can only view their annual budgets, but can't change them in any way.</br>
Primary users can create new consolidated budget for a selected year.
...
## Reports
### Report Inquiry page
On the report inquiry page, users can view their saved reports and generate new ones by selecting the year and month. A report will be generated that will reflect all expenses from the beginning of January of the target year, to the last day of the selected month and year.</br>
...
Primary users can also generate and save consolidated reports, which include not only their own financial transactions, but also those made by all their Secondary users.
...
The horizontal sections of the report divide the report on the basis of payment groups - salaries, support and assets. Each section is further divided by the subtype of the payments.</br>
...
<a href="#table-of-contents">Back to index table</a>
## Error page
If the application cannot process a request properly, or the user engages in parameter tampering, a simple error page will be displayed with a custom message, describing this particular error.
